...
import '../App.cs';
import AllianceLogo from './Images/Login/Alliance Logo.svg'
...
export class Login extends Component{
    ...
    /**
     * toggles the passwordShown state value using setState
                        ...
                        <Form>
                            <Form.Group className='mb-3' controlId='formGridUsername'>
                                ...
                                <InputGroup className='mb-2'>
                                    ...
                                    <Form.Control type='text' id='username' value={usernameFieldValue} onChange={this.handleUsernameInput}></Form.Control>
                                    <Button variant='danger' className='btn-inline-form' onClick={this.clearUsernameField}>
                            ...
                            <Form.Group className='mb-3' controlId='formGridPassword'>
                                ...
                                <InputGroup className='mb-2'>
                                    ...
                                    <Form.Control type={passwordShown ? 'text' : 'password'} id='password'></Form.Control>
                                    <Button variant='danger' className='btn-inline-form' onClick={this.togglePasswordVisibility}>
                                        {passwordShown ? 
