...
const handleShow = () => setShow(true);
  ...
  <div class="input-group-prepend">
    <button class="btn btn-outline-secondary" type="button" style={{border: "0"}}><FaIcons.FaSearch size={35}/></button>
  </div>
  <input type="text" class="form-control" placeholder="e.g. John Doe" aria-label="" aria-describedby="basic-addon1"></input>
</div>
          </div>
          <div className="navbar-right">
          <FaIcons.FaSignOutAlt className="logout-icon" size={30} style={{display: "flex", marginLeft: -110 }} onClick={handleShow} />
        </div>
        </div>
      ...
      <Modal show={show} onHide={handleClose} >
        ...
        <div className="text-center">
          <img src={emergency} alt="emergency" style={{alignContent: "center"}}></img>
          <h2>Sign Out</h2>
